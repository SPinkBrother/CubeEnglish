    ...
    <div className='flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70 '>
        ...
        ${!sideBarOpen ? 'max-sm:w-0 overflow-hidden' : 'max-sm:w-60 max-sm:pl-10'}
          ...
          <img src={assets.close_icon} 
            ...
            {/* Nav items */}
          <a onClick={() => setSideBarOpen(false)} href="#" className='sm:hover:border-b'>Trang chủ</a>
          <a onClick={() => setSideBarOpen(false)} href="#services" className='sm:hover:border-b'>Khoá học</a>
          <a onClick={() => setSideBarOpen(false)} href="#our-work" className='sm:hover:border-b'>Về chúng mình</a>
          <a onClick={() => setSideBarOpen(false)} href="#contact-us" className='sm:hover:border-b'>Liên hệ</a>
        </div>
        ...
        <div className='flex items-center gap-2 sm:gap-4'>
          ...
          cursor-pointer hover:scale-105 transition-all'>
            Conntect <img src={assets.arrow_icon} width={14} alt="" />
          </a>
        </div>
    </div>
  )
